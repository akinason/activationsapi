# Generated by Django 3.0.5 on 2020-04-04 01:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rave_public_key', models.CharField(blank=True, help_text='Plublic key obtained from https://bit.ly/3aHzeFJ. NB: This link contains a referral id.', max_length=255, verbose_name='Flutterwave Public Key')),
                ('rave_secret_key', models.CharField(blank=True, help_text='Optional: If provided, we will verify payments before marking them as verified otherwise, we simply mark as verified..', max_length=255, verbose_name='Flutterwave Secret Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview_image', models.FileField(blank=True, storage=storage_backend.PreviewImageStorage(), upload_to='', verbose_name='preview image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, max_length=20, verbose_name='mobile')),
                ('payment_response', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, verbose_name='payment response')),
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='created on')),
                ('updated_on', models.DateTimeField(auto_now_add=True, verbose_name='updated on')),
